...
$language_data = array(
    ...
    'setsearch', 'setunion', 'trace', 'vecextract', 'vecsort', 'vector', 'vectorsmall',
    'vectorv', 'ellheegner', 'cmp'),
    2 => array('void', 'bool', 'negbool', 'small', 'int', 'real', 'mp', 'var', 'pol', 'vecsmall',
    'vec', 'list', 'str', 'genstr', 'gen', 'lg', 'typ')
    3 => array('TeXstyle', 'breakloop', 'colors', 'compatible', 'datadir', 'debug', 'debugfiles',
    'debugmem', 'echo', 'factor_add_primes', 'factor_proven', 'format', 'graphcolormap',
    'graphcolors', 'help', 'histfile', 'histsize', 'lines', 'linewrap', 'log', 'logfile',
    'new_galois_format', 'output', 'parisize', 'path', 'prettyprinter', 'primelimit',
    'prompt_cont', 'prompt', 'psfile', 'readline', 'realprecision', 'recover', 'secure',
    'seriesprecision', 'simplify', 'strictmatch', 'timer'),
    4 => array('alarmer','archer','errpile','gdiver','impl','invmoder','overflower','syntaxer',
    'talker','typeer','user')
    ),
    'SYMBOLS' => array(
        1 => array(
    ...
    'REGEXPS' => array(
        0 => array( # types marked on variables
            GESHI_SEARCH => '(?<!\\)"(t_INT|REAL|INTMOD|FRAC|FFELT|COMPLEX|PADIC|QUAD|POLMOD|POL|SER|RFRAC|QFR|QFI|VEC|COL|MAT|LIST|STR|VECSMALL|CLOSURE)"',
            GESHI_REPLACE => '\\1',
            GESHI_MODIFIERS => '',
            GESHI_BEFORE => '"',
            GESHI_AFTER => '"'
