...
$language_data = array(
    ...
    'KEYWORDS' => array(
        1 => array(
            ...
            'bnrrootnumber','bnrstark','break','Catalan','ceil','centerlift',
            'charpoly','chinese','clone','cmp','Col','component','concat',
            'conj','conjvec','content','contfrac','contfracpnqn','copy','core',
            'coredisc','cos','cosh','cotan','DEBUGLEVEL','default',
            'denominator','deriv','derivnum','diffop','digits','dilog','dirdiv',
            'direuler','dirmul','dirzetak','divisors','divrem','eint1','elladd',
            'ellak','ellan','ellanalyticrank','ellap','ellbil','ellcard',
            'ellchangecurve','ellchangepoint','ellchangepointinv',
            'ellconvertname','elldivpol','elleisnum','elleta','ellfromj',
            'ellgenerators','ellglobalred','ellgroup','ellheegner','ellheight',
            'ellheightmatrix','ellidentify','ellinit','ellisoncurve','ellj',
            'ellL1','elllocalred','elllog','elllseries','ellminimalmodel',
            'ellmodulareqn','ellmul','ellneg','ellorder','ellordinate',
            'ellperiods','ellpointtoz','ellpow','ellrootno','ellsearch',
            'ellsigma','ellsub','elltaniyama','elltatepairing','elltors',
            'ellweilpairing','ellwp','ellzeta','ellztopoint','erfc','errname',
            'error','eta','Euler','eulerphi','eval','exp','extern','externstr',
            'factor','factorback','factorcantor','factorff','factorial',
            'factorint','factormod','factornf','factorpadic','ffgen','ffinit',
            'fflog','ffnbirred','fforder','ffprimroot','fibonacci','floor',
            'for','forcomposite','fordiv','forell','forpart','forprime',
            'forqfvec','forstep','forsubgroup','forvec','frac','galoisexport',
            ...
            'gammah','gcd','gcdext','genus2red','getheap','getrand','getstack',
            'gettime','global','hammingweight','hilbert','hyperu','I',
            'idealadd','idealaddtoone','idealappr','idealchinese',
            'idealcoprime','idealdiv','idealfactor','idealfactorback',
            'idealfrobenius','idealhnf','idealintersect','idealinv','ideallist',
            'ideallistarch','ideallog','idealmin','idealmul','idealnorm',
            'idealnumden','idealpow','idealprimedec','idealramgroups',
            'idealred','idealstar','idealtwoelt','idealval','if','iferr','imag',
            'incgam','incgamc','input','install','intcirc','intformal',
            'intfouriercos','intfourierexp','intfouriersin','intfuncinit',
            'intlaplaceinv','intmellininv','intmellininvshort','intnum',
            'intnuminit','intnuminitgen','intnumromb','intnumstep',
            'isfundamental','ispolygonal','ispower','ispowerful','isprime',
            'isprimepower','ispseudoprime','issquare','issquarefree',
            'istotient','kill','kronecker','lambertw','lcm','length','lex',
            'lift','lindep','List','listcreate','listinsert','listkill',
            'listpop','listput','listsort','lngamma','local','log','Mat',
            'matadjoint','matalgtobasis','matbasistoalg','matcompanion',
            'matconcat','matdet','matdetint','matdiagonal','mateigen',
            'matfrobenius','mathess','mathilbert','mathnf','mathnfmod',
            'mathnfmodid','mathouseholder','matid','matimage','matimagecompl',
            'matindexrank','matintersect','matinverseimage','matisdiagonal',
            'matker','matkerint','matmuldiagonal','matmultodiagonal',
            'matpascal','matqr','matrank','matrix','matrixqz','matsize',
            'matsnf','matsolve','matsolvemod','matsupplement','mattranspose',
            'max','min','minpoly','Mod','modreverse','moebius','my',
            'newtonpoly','next','nextprime','nfalgtobasis','nfbasis',
            'nfbasistoalg','nfcertify','nfdetint','nfdisc','nfeltadd',
            'nfeltdiv','nfeltdiveuc','nfeltdivmodpr','nfeltdivrem','nfeltmod',
            'nfeltmul','nfeltmulmodpr','nfeltnorm','nfeltpow','nfeltpowmodpr',
            ...
            'polchebyshev','polcoeff','polcompositum','polcyclo',
            'polcyclofactors','poldegree','poldisc','poldiscreduced',
            'polgalois','polgraeffe','polhensellift','polhermite',
            'polinterpolate','poliscyclo','poliscycloprod','polisirreducible',
            'pollead','pollegendre','polrecip','polred','polredabs',
            'polredbest','polredord','polresultant','polresultantext','Polrev',
            'polroots','polrootsff','polrootsmod','polrootspadic','polsturm',
            'polsubcyclo','polsylvestermatrix','polsym','poltchebi',
            'poltschirnhaus','polylog','polzagier','precision','precprime',
            'prime','primepi','primes','print','print1','printf','printsep',
            'printsep1','printtex','prod','prodeuler','prodinf','psdraw','psi',
            'psploth','psplothraw','qfauto','qfautoexport','Qfb','qfbclassno',
            'qfbcompraw','qfbhclassno','qfbnucomp','qfbnupow','qfbpowraw',
            'qfbprimeform','qfbred','qfbsolve','qfgaussred','qfisom',
            'qfisominit','qfjacobi','qflll','qflllgram','qfminim',
            'qfperfection','qfrep','qfsign','quadclassunit','quaddisc',
            'quadgen','quadhilbert','quadpoly','quadray','quadregulator',
            'quadunit','quit','random','randomprime','read','readstr','readvec',
            'real','removeprimes','return','rnfalgtobasis','rnfbasis',
            ...
            'rnfpseudobasis','rnfsteinitz','round','select','Ser','seralgdep',
            'serconvol','serlaplace','serreverse','Set','setbinop',
            'setintersect','setisset','setminus','setrand','setsearch',
            'setunion','shift','shiftmul','sigma','sign','simplify','sin',
            'sinh','sizebyte','sizedigit','solve','sqr','sqrt','sqrtint',
            'sqrtn','sqrtnint','stirling','Str','Strchr','Strexpand',
            'Strprintf','Strtex','subgrouplist','subst','substpol','substvec',
            'sum','sumalt','sumdedekind','sumdigits','sumdiv','sumdivmult',
            'sumformal','suminf','sumnum','sumnumalt','sumnuminit','sumpos',
            'system','tan','tanh','taylor','teichmuller','theta','thetanullk',
            'thue','thueinit','trace','trap','truncate','type','unclone',
            'until','valuation','variable','Vec','vecextract','vecmax','vecmin',
            'Vecrev','vecsearch','Vecsmall','vecsort','vector','vectorsmall',
            'vectorv','version','warning','weber','whatnow','while','write',
            'write1','writebin','writetex','zeta','zetak','zetakinit',
